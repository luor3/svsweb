<div class="my-2 lg:sticky top-1/4 z-51">
    <div class="bg-white rounded-xl border-4 border-blue-500 border-opacity-50">
        <div class="text-center p-6 border-b">
            ...
            <div class="mt-5">
                <a href="{{ route('userprofile') }}" class="border rounded-full py-2 px-4 text-xs font-semibold text-gray-700">
                    Manage your Account
                </a>
            </div>
        </div>
        <div class="border-b">
            <a href="{{ route('jobs') }}" class="px-4 py-2 hover:bg-gray-100 flex">
                ...
                <div class="pl-3">
                    <p class="text-sm font-medium text-gray-800 leading-none">View Jobs</p>
                    <p class="text-xs text-gray-500">View your current jobs status</p>
                </div>
            </a>
            <a href="{{ route('jobs.create') }}" class="px-4 py-2 hover:bg-gray-100 flex">
                ...
                <div class="pl-3">
                    <p class="text-sm font-medium text-gray-800 leading-none">Job Submission</p>
