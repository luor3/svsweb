<div>
    ...
    <div x-data="{ gridView: true}" class="mt-4">
        ...
        @else
            <div class="flex flex-wrap md:grid md:grid-cols-2" x-show="gridView">
                @foreach($demos as $demo)   
                    <div class='self-center w-11/12 md:w-5/6 mt-10 bg-white mx-auto rounded-2xl shadow-2xl overflow-hidden'>
                        <div>
                        ...
                        <div class='relative bg-gray-200 text-center pt-2 text-base'>
                            ...
                            <div class="mt-3 flex justify-around">
                                <button class="w-2/5 lg:w-1/4 mb-5 py-3 bg-black text-center text-white font-semibold rounded-xl shadow-md hover:bg-gray-700 focus:outline-none" wire:click="downloadFile( {{$demo->id}} , true)" wire:loading.attr="disabled">
                                ...
                                <button class="text-center w-2/5 lg:w-1/4 mb-5 py-3 bg-red-800 text-white font-semibold rounded-xl shadow-md hover:bg-red-500 focus:outline-none" wire:click="downloadFile( {{$demo->id}} , false)" wire:loading.attr="disabled">
                                    <span class="align-middle inline-block">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                        </svg>
            ...
            <div class="flex flex-wrap" x-show="!gridView">
                <div class="p-2 w-full antialiased">
                    <div x-data="{count : 0}">
                        @foreach($demos as $demo) 
                        <!-- start  -->
                        <div class="bg-gray-100 mx-auto border rounded-sm text-gray-700 mb-2 h-30">
                            <div class="flex p-3 border-l-8 border-indigo-700">
                                ...
                                <div class="flex flex-col ml-3">
                                    ...
                                    <button class="p-1 bg-black text-center text-white font-semibold shadow-md hover:bg-gray-700 rounded focus:outline-none" wire:click="downloadFile( {{$demo->id}} , true)" wire:loading.attr="disabled">
                                    ...
                                    <button class="mt-1 p-1 bg-red-700 text-white font-semibold shadow-md hover:bg-red-500 rounded focus:outline-none" wire:click="downloadFile( {{$demo->id}} , false)" wire:loading.attr="disabled">                                   
                                        <svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                        </svg>    
                                        Output                   
